...
public abstract class Shape {
    ...
    class Circle extends Shape implements Drawable, Deletable {
        ...
        @Override
        public void delete() {
            System. out.println("Удаляем круг");
        }

    }

    class Square extends Shape implements Drawable, Deletable {
        private double side;
    ...
    class Rectangle extends Shape implements Drawable, Deletable {
        ...
        @Override
        public void delete() {
            System. out.println("Удаляем прямоугольник");
        }
    }

    class Trapezoid extends Shape implements Drawable, Deletable {
        ...
        @Override
        public void draw() {
            System. out.println("Рисуем трапецию");
        }
        @Override
        public void delete() {
            System. out.println("Удаляем трапецию");
        }
    }

    class Rhombus extends Shape implements Drawable, Deletable {
        private double side;
        ...
        @Override
        public void delete() {
            System. out.println("Удаляем ромб");
        }
    }

    class Ellipse extends Shape implements Drawable, Deletable {
        ...
        @Override
        public void delete() {
            System. out.println("Удаляем эллипс");
        }
    }

    class Parallelepiped extends Shape implements Drawable, Deletable {
        ...
        @Override
        public void draw() {
            System. out.println("Рисуем параллелепипед");
        }
        @Override
        public void delete() {
            System. out.println("Удаляем параллелепипед");
        }
